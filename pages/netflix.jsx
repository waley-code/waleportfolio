    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            "Neflix Clone" is an enthralling streaming platform that brings the
            best of the cinematic world to audiences worldwide. This captivating
            project was meticulously built using cutting-edge technologies like
            React, MongoDB, TypeScript, and Prisma, ensuring a seamless user
            experience and a robust backend infrastructure. The front-end of
            "Neflix Clone" was crafted using React, a popular and dynamic
            JavaScript library, which allowed for the creation of a highly
            interactive and visually appealing user interface. The interface
            boasts a user-friendly design, making it easy for subscribers to
            navigate through the vast library of movies and TV shows available
            on the platform.
            <br />
            ...
            smooth playback and fast access to users' favorite movies and TV
            series. TypeScript was utilized to bring an added layer of static
            ...
            <br />
            Furthermore, "Neflix Clone" leverages Prisma, an open-source
            database toolkit, to seamlessly connect the front-end and back-end
            layers of the platform. This integration streamlined data
            management, allowing for effortless querying and manipulation of the
            content database. To cater to a global audience and provide a
            ...
            Vercel's global edge network ensures that users from various regions
            can access the platform with minimal latency, ensuring an
